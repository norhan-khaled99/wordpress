...
function yummy_bites_dynamic_css(){
    ...
    :root {
        ...
        --yummy-btn-roundness-top: <?php echo absint( $button_roundness['top'] ); ?>px;
        --yummy-btn-roundness-right: <?php echo absint( $button_roundness['right'] ); ?>px;
        --yummy-btn-roundness-bottom: <?php echo absint( $button_roundness['bottom'] ); ?>px;
        --yummy-btn-roundness-left: <?php echo absint( $button_roundness['left'] ); ?>px;
        --yummy-btn-padding-top: <?php echo absint( $button_padding['top'] ); ?>px;
        --yummy-btn-padding-right: <?php echo absint( $button_padding['right'] ); ?>px;
        --yummy-btn-padding-bottom: <?php echo absint( $button_padding['bottom'] ); ?>px;
        --yummy-btn-padding-left: <?php echo absint( $button_padding['left'] ); ?>px;
	}
