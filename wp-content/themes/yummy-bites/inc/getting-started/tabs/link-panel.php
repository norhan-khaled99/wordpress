...
<div class="panel-right">
	...
	<div class="panel-aside">
		...
		<a class="button button-primary" href="<?php echo esc_url( 'https://wpdelicious.com/docs-category/' . YUMMY_BITES_THEME_TEXTDOMAINE . '/' ); ?>" title="<?php esc_attr_e( 'Visit the knowledge base', 'yummy-bites' ); ?>" target="_blank"><?php esc_html_e( 'Visit the Knowledge Base', 'yummy-bites' ); ?></a>
