...
<div id="plugins-panel" class="panel-left visible">
	...
	<p><?php printf( esc_html__( 'Below is a list of recommended plugins to install that will help you get the most out of %1$s. Although each plugin is optional, it is recommended that you at least install the Delicious Recipes, BlossomThemes Email Newsletter & BlossomThemes Social Feed to create a website similar to the %1$s demo.', 'yummy-bites' ), YUMMY_BITES_THEME_NAME ); ?></p>
