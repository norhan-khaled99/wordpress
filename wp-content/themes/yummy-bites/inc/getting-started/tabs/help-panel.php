...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://wpdelicious.com/docs-category/' . YUMMY_BITES_THEME_TEXTDOMAINE . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'yummy-bites' ); ?>" target="_blank">
    ...
    <div class="panel-aside">
        ...
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'yummy-bites' ), '<a href="'. esc_url( 'https://wpdelicious.com/docs-category/' . YUMMY_BITES_THEME_TEXTDOMAINE . '/' ) .'" target="_blank">', '</a>' ); ?></p>
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.wpdelicious.com/yummy-bites/'); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'yummy-bites' ); ?>" target="_blank">
