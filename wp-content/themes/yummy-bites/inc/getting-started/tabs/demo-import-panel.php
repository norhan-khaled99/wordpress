...
<div id="demo-panel" class="panel-left">
	...
	<div class="text-block">
		<p><?php printf(__( 'Yummy Bites includes variety of starter templates suited for recipes websites. New designs are added frequently to the collection. Visit %1$shere%2$s to see all the templates.', 'yummy-bites' ), '<a href="https://demo.wpdelicious.com/yummy-bites/" target="_blank">', '</a>' );?>
	</div>	
