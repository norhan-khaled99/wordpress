        ...
        if ($image_size) { ?>
            <div class="svg-holder">
                <svg class="fallback-svg" viewBox="0 0 <?php echo esc_attr($image_size['width']); ?> <?php echo esc_attr($image_size['height']); ?>" preserveAspectRatio="none">
                    <rect width="<?php echo esc_attr($image_size['width']); ?>" height="<?php echo esc_attr($image_size['height']); ?>" style="fill:<?php echo yummy_bites_sanitize_rgba($primary_color); ?>;opacity: 0.03"></rect>
                </svg>
            </div>
        <?php
        }
...
if ( ! function_exists('yummy_bites_is_btif_activated') ) :
    /**
     * Is BlossomThemes Social Feed active or not
     */
    function yummy_bites_is_btif_activated(){
