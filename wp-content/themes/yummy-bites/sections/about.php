...
if( $abt_img_id ) $background_image = ' style="background-image: url(' . esc_url( $abt_bg_image ) . ');"';

if( $ed_about_section && ( $abt_title || $abt_description ) ){ ?>
    <section id="about_section" class="tr-about-section" <?php echo $background_image; ?>  >        
        <div class="container">
